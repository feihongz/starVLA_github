...
CHECKPOINT="${CHECKPOINT:-playground/Checkpoints/var_stage1_robotwin_abs_clean_random_e64_aeinit_productvq_g16_s1_2_4_8_16_32_50/best_recon.ckpt}"
CONFIG_YAML="${CONFIG_YAML:-examples/Robotwin/train_files/train_var_stage1_robotwin_abs_clean_random_e64_aeinit_productvq_g16_s1_2_4_8_16_32_50.yaml}"
OUT_DIR="${OUT_DIR:-playground/Checkpoints/var_stage1_robotwin_abs_clean_random_e64_aeinit_productvq_g16_s1_2_4_8_16_32_50/replay}"
