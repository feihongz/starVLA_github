...
OUTPUT="${CACHE_OUTPUT:-playground/Checkpoints/var_stage1_robotwin_abs_clean_e64_aeinit_productvq_g16_s1_2_4_8_16_32_50/stage2_token_cache_full.pt}"
...
"${PYTHON_BIN}" starVLA/training/build_var_stage2_token_cache.py \
  ...
  --stage1_artifact playground/Checkpoints/var_stage1_robotwin_abs_clean_e64_aeinit_productvq_g16_s1_2_4_8_16_32_50/best_recon.ckpt \
  --output "${OUTPUT}" \
  --mode train \
