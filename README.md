...
> **VAR benchmark reproduction:** The open-source Stage 1, Stage 2, and eval
> chains for LIBERO, RoboCasa GR1, and RoboTwin 2.0 are indexed in
> [docs/training_eval_chains.md](docs/training_eval_chains.md), with runnable
> reproduction commands in
> [docs/reproduce_var_benchmarks.md](docs/reproduce_var_benchmarks.md).
